...
class TeleopDrone
{
	...
	TeleopDrone::TeleopDrone():_x(0.0),_y(0.0),_z(0.0)
	{
	 _trajectory_point_pub = _nh.advertise<trajectory_msgs::MultiDOFJointTrajectoryPoint>("position_hold/trajectory", 1000); 
	}
	...
	void TeleopDrone::keyLoop()
	{
	  ...
	  for (;;)
	  {
	    ...
	    point_msg.transforms[0].resize(1);
	    ...
	    if (dirty==true)
	    {
	      _trajectory_point_pub.publish(trajectory_point);
	      dirty = false;
	    }
	  }
